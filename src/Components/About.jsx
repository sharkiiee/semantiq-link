...
export default function About() {
  ...
  const numberClass = "text-xl font-bold text-myBlue my-4";
  return (
      ...
      <div className="absolute top-6 p-20 w-full text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p>
            ...
            integrity, and care-always putting your objectives at the forefront.
          </p>
          <button className="rounded-full px-8 py-1 border border-myBlue my-6 text-myBlue hover:bg-orange-300 hover:text-white hover:border-none">
            Read More
          </button>
        </div>
        <ul className="flex justify-between mt-10 text-left">
          ...
          <li className="flex gap-4">
            ...
            <div className="py-4">
              <p className={numberClass} style={{fontSize:"3.75rem"}}>3,194+</p>
          ...
          <li className="flex gap-4">
            ...
            <div className="py-4">
              <p className={numberClass} style={{fontSize:"3.75rem"}}>32,031+</p>
              <p>Task Completed</p>
            </div>
          </li>
        </ul>
