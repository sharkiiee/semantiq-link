        ...
        <div>
          <div className="flex justify-between">
            <div className="max-w-md">
              <h3 className="text-3xl mb-2 font-bold text-[#1c3a5b]">
            ...
            <button className="rounded-full px-8 py-1 border border-myBlue mt-12 text-myBlue hover:bg-orange-300 hover:text-white hover:border-none h-9">
              View All Services
            </button>
          </div>
          <hr className="border-t border-black/10 m-8" />
          <ul className="flex flex-wrap gap-6">
            {SERVICES.map((obj) => {
              return (
                <li
                  key={obj.title}
                  className="h-32 min-w-80 max-w-80 bg-white p-4 rounded-md"
                >
      ...
      <div className="py-10 px-20 flex justify-between">
        <div className="max-w-3xl">
          <h2 className="uppercase text-3xl mb-2 font-bold text-[#1c3a5b]">
            Why need paid guest post to increase
          </h2>
          <h3 className="uppercase text-3xl mb-2 font-bold text-[#475e88]">
            website SEO ranking?
          </h3>
          <p>
            Brand Chatters connects your content with high-traffic, trusted
            websites. Our expert guest posting and link-building services earn
            quality backlinks that boost your SEO, traffic, and Google rankings.
          </p>
        </div>
        <button className="rounded-full px-8 py-1 border border-myBlue mt-12 text-myBlue hover:bg-orange-300 hover:text-white hover:border-none h-9">
          Get Consult
